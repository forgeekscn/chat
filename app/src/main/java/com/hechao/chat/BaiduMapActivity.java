...
//        mBaiduMap.setBaiduHeatMapEnabled(true);
    ...
    protected void onDestroy() {
        super.onDestroy();
        // Fix resource leak: stop location client
        if (mLocationClient != null && mLocationClient.isStarted()) {
            mLocationClient.stop();
        }
        // in activity execute onDestroy, execute mMapView.onDestroy()
        if (mMapView != null) {
            mMapView.onDestroy();
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        // in activity execute onResume, execute mMapView.onResume()
        if (mMapView != null) {
            mMapView.onResume();
        }
    }
    ...
    protected void onPause() {
        super.onPause();
        // in activity execute onPause, execute mMapView.onPause()
        if (mMapView != null) {
            mMapView.onPause();
        }
    }
